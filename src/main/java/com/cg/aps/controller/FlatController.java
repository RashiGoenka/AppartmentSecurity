...
import com.cg.aps.service.FlatServiceImpl;
	...
	public class FlatController {
		...
		public String deleteFlat(@PathVariable ("flatno") String id)
		{
			service.delete(id);
			return "deleted";
		}
		...
		List<FlatEntity> getByName(@PathVariable ("name") String name) throws RecordNotFoundException
		{
		...
		@GetMapping("/getAll") 
		List<FlatEntity> search()throws RecordNotFoundException
		{
