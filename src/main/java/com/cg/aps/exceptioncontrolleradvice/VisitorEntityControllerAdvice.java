...
@ControllerAdvice
public class VisitorEntityControllerAdvice extends ResponseEntityExceptionHandler {

	@ExceptionHandler(value = UserIdNotFoundException.class) // You can Have one more exception objects
	public ResponseEntity<?> handleUserIdNotFoundException(UserIdNotFoundException me) {
