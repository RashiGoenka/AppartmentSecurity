...
@ControllerAdvice
public class DomControllerAdvice extends ResponseEntityExceptionHandler {

	@ExceptionHandler(value = FlatIdNotFoundException.class) // You can Have one more exception objects
	public ResponseEntity<?> handleMessageIdNotFoundException(FlatIdNotFoundException me) {
